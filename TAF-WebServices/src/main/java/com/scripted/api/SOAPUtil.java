...
public class SOAPUtil {
	public static Logger LOGGER = LogManager.getLogger(SOAPUtil.class);
	...
	public static void writeToFile(Document xmlDoc, String fileName) throws TransformerException {
		try {
			String prjctPath = System.getProperty("user.dir");
